...
pl.add_mesh(pc, render_points_as_spheres=True, point_size=5, color='m')
pl.add_axes()

pl.set_background('w')

# camera settings
pl.camera.position = (3., 0., 0.5)
pl.camera.focal_point = (0., 0., 0.)

for i in range(nt):
    # transform points
    pointst1 = transform(points1, orient1[i,:], pos1[i,:])
    pointst2 = transform(points2, orient2[i,:], pos2[i,:])
